...
Let's discuss how the algorithm works on a seperate page reserved for Kohonen maps (visit : https://indularm.github.io/SOM/). For now let's learn how to use it to help gain knowledge about the dataset that we deal with. 
